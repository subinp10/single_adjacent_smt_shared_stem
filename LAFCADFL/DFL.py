...
# To find bendings in a given path
def findBendings(finalPath):
    bendings = 0
...
def bestFlow(grid, inlet, outlet, R):
    ...
    bendings = findBendings(finalPath)
...
def main():
    ...
    grid[7][4] = grid[7][5] = grid[8][4] = "R3"
    grid[8][5] = "R4"

    grid[7][7] = grid[7][8] = "R2"
    grid[8][7] = grid[8][8] = "R4"
    ...
    reagents = ["R1", "R2", "R3", "R4"] # list of reagents that are needed for the mixing process
    inlet = [0,9]
    outlet = [9,0]
